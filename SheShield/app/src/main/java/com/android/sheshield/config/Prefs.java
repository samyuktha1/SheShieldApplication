package com.android.sheshield.config;

import android.content.Context;
import android.content.SharedPreferences;

import com.android.sheshield.BuildConfig;
import com.android.sheshield.SheShield;

@SuppressWarnings("unused")
public class Prefs {

    public static SharedPreferences prefs = SheShield.getAppContext().getSharedPreferences(BuildConfig.APPLICATION_ID, Context.MODE_PRIVATE);
